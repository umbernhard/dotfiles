...
call s:Highlight('MatchParen',      s:lime, s:moss, 'bold', '')

call s:Highlight('LineNr',          s:lilac, '', '', '')
...
call s:HighlightX('ColorColumn',    '', s:greys[4], '', '')
...
call s:HighlightX('Visual',         s:black, s:sunny, '', '')
